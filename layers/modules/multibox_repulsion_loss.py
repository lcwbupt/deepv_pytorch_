...
from ..box_utils import match_new, log_sum_exp
from .repulsion_loss import RepulsionLoss


class MultiBoxRepulsionLoss(nn.Module):
    ...
    def __init__(self, num_classes, overlap_thresh, prior_for_matching,
                 ...
                 use_gpu=True):
        super(MultiBoxRepulsionLoss, self).__init__()
    ...
    def forward(self, predictions, targets):
        ...
        for idx in range(num):
            ...
            match_new(self.threshold, predicts, truths, defaults, self.variance, labels,
