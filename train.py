...
from ssd import build_ssd, build_ssd_resnet18
import os
import sys
import time
import torch
...
#     ssd_net = build_ssd_resnet18('train', cfg['min_dim'], cfg['num_classes'])
    net = ssd_net
    ...
    criterion = MultiBoxLoss(cfg['num_classes'], 0.45, True, 0, True, 3, 0.5,
                             False, args.cuda)
